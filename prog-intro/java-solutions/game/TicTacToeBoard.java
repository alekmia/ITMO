...
public class TicTacToeBoard implements Board, Position {
    ...
    private boolean checkDraw() {
        int count = 0;
        for (int r = 0; r < 3; r++) { // was 3
            for (int c = 0; c < 3; c++) {  // was 3
                if (field[r][c] == Cell.E) {
                    count++;
                }
            }
    ...
    public boolean isValid(final Move move) {
        return 0 <= move.getRow() && move.getRow() < 3 //was 3
                && 0 <= move.getCol() && move.getCol() < 3  //was 3
